...
curl -fsSL https://raw.githubusercontent.com/jronminh/deb-native/v0.1.0-prealpha/install.sh | DEB_NATIVE_REF=v0.1.0-prealpha sh

exec bash          # or: . ~/.bashrc
figlet hi          # an installed program, run by name
```

Or the rolling edge: replace both `v0.1.0-prealpha` occurrences with `main`.
